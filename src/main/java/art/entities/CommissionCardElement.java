...
public class CommissionCardElement extends PanacheEntity{
    ...
    @ElementCollection
    @CollectionTable(name = "commission_card_element_images", 
    ...
    public static void add(String title, String description, List<String> exampleImageUrls, Double price, CommissionCard commissionCard) {
